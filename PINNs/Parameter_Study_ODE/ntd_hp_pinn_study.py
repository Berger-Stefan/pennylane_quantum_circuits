...
study_name = "non_trivial_dynamics_pinn"  # Unique identifier of the study.
...
study = optuna.create_study(sampler=optuna.samplers.RandomSampler(), study_name=study_name, storage=storage_name, load_if_exists=True)
