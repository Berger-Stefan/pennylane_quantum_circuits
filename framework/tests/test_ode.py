...
def test_adam():
    ...
    solver = framework.Solver(data, model, pde_res_fnc, [boundary_res_fnc], loss_scaling=[1,30], plot_update_functions=plot_update_functions)

    solver_setting_adam  = {"optimizer":"adam" , "learning_rate":0.05, "update_interval":5,"n_iter":10}
...
def test_lbfgs():
    ...
    solver_settings_lbfgs = {"optimizer":"lbfgs", "learning_rate":1.0, "update_interval":1, "n_iter":4}
